...
| LSPosed Irena | [re-zero001/LSPosed-Irena](https://github.com/re-zero001/LSPosed-Irena) | CI builds only — no releases, download requires GitHub token ([see limitations](#known-limitations)) |
...
| SUSFS | [sidex15/susfs4ksu-module](https://github.com/sidex15/susfs4ksu-module) | Reports kernel version, not module version — may show false updates ([see limitations](#known-limitations)) |
